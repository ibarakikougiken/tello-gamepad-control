...
func (sm *PilotState) Update(
	...
	if Tello != nil {
		go func() {
			if inpututil.IsStandardGamepadButtonJustPressed(GamepadId, ebiten.StandardGamepadButtonLeftTop) {
				Tello.TakeOff()
			} else if inpututil.IsStandardGamepadButtonJustPressed(GamepadId, ebiten.StandardGamepadButtonLeftBottom) {
				Tello.Land()
			} else if inpututil.IsStandardGamepadButtonJustPressed(GamepadId, ebiten.StandardGamepadButtonLeftRight) {
				Tello.RightFlip()
			} else if inpututil.IsStandardGamepadButtonJustPressed(GamepadId, ebiten.StandardGamepadButtonLeftLeft) {
				Tello.LeftFlip()
			}
		}()
